#!/bin/bash
#Code:HackerByYakup
#İnstagram: @hackerbyyakup
#Youtube : YV-Production
echo -e '\033[31;40;1m 
		   ─────█─▄▀█──█▀▄─█─────
		   ────▐▌──────────▐▌────
		   ────█▌▀▄──▄▄──▄▀▐█────
      ...
      \e[35m      ☠         Code  : HackerByYakup     ☠
	  \e[34m☠	     Github : Hacker By Yakup      ☠
	 \e[33m☠  	    Youtube : YV-Production          ☠
	\e[32m☠ 	   İnstagram : @hackerbyyakup           ☠
